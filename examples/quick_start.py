...
if __name__ == "__main__":
    ...
    # manager = MazeManager()
    ucs_manager = MazeManager()
    astar_manager = MazeManager()
    ...
    maze = ucs_manager.add_maze(20,20)
    maze2 = astar_manager.add_existing_maze(maze)
    ...
    #
    ucs_manager.solve_maze(maze.id, "UniformCostSearch")
    ucs_manager.show_solution(maze.id)

    astar_manager.solve_maze(maze2.id, "AStarSearch")
    astar_manager.show_solution(maze2.id)
    ...
    # manager.show_solution_animation(maze.id) # 풀이 방법1
    # ucs_manager.show_solution_animation(maze.id) # 풀이 방법1
    # astar_manager.show_solution_animation(maze.id)
    ...
    # manager.show_solution(maze.id) #풀이방법2
